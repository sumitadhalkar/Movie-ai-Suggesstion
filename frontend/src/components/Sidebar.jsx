      ...
      <nav className={styles.nav}>
        {NAV.map((item) => (
          <button
            ...
            title={item.label}
          >
            {active === item.id && <span className={styles.indicator} />}
            {item.icon}
          </button>
        ))}
      </nav>
      <div className={styles.bottom}>
        <button className={styles.navBtn} title="Profile">
          <ProfileIcon />
        </button>
      </div>
    </aside>
